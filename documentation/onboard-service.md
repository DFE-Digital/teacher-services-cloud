...
1. Note the data from the `ga_wif_config` output to populate `azure-client-id`, `azure-tenant-id` and `azure-subscription-id` in the workflows. It is recommended to store them as Github environment secrets.
