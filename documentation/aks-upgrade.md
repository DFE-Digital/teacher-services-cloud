...
1. If you see any failures, login via Azure portal and go to the AKS Cluster.
2. Click on Activity Log on left hand panel, it lists all events, check failure events and it will give the failure reason.
